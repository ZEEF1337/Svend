...
$query = "SELECT users.ID, users.Fornavn, users.Efternavn, ur.Navn AS Rolle, us.Navn AS Specialitet FROM users";
$query .= " INNER JOIN user_roles AS ur ON ur.ID = users.Rolle";
$query .= " INNER JOIN user_specialties AS us ON us.ID = users.Specialitet ORDER BY users.ID DESC;";
