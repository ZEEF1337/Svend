...
if(!isset($_GET['token']) || !isset($_GET['spec'])){
    $out['result'] = 0;
...
$query = "SELECT users.ID, users.Fornavn, users.Efternavn FROM users WHERE users.Rolle <= 2 && users.Specialitet = $givenSpec;";
